...
def main():
    for cluster in clusters:
        ...
        notice_msg = (
            ...
            f"\n"
            f":k체크: 주차 등록 설문조사 후 *2층 인사총무팀에서 주차증* 수령\n"
            f":k체크: 아래 위반 사항 확인 될 경우 *주차 위반 스티커 부착* 조치 예정\n"
            f">주차장 주차라인 내 주차 준수 / 경차 및 전기차 전용 준수 / 8층 주차장 외 다른 층 임의 주차 금지\n"
            f">외부 불법 주/정차 수시 단속 진행 중_관공서\n"
            f">부속동(직원식당) 주차장 주차불가, 주차위반 스티커 또는 견인 조치 예정\n\n"
            f"\n"
