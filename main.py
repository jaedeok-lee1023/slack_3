...
def main():
    for cluster in clusters:
        ...
        f":자동차:  [주차 등록 및 주차장 이용 공지]  :자동차:\n\n"

        notice_msg = (
            f"안녕하세요? 평택 클러스터 구성원 여러분\n올바른 주차등록과 주차장 이용을 위해 구성원 여러분들께 다음과 같이 공지 드리오니 꼭 협조 부탁드리겠습니다.\n\n"
            f":heavy_check_mark: 주차 등록 시 스레드 링크를 통한 설문조사 후 *2층 통합사무실에서 주차증* 수령\n(설문조사 내 본인차량 *자동차등록증* 준비 및 *증빙자료* 첨부 必\n\n"
            f":heavy_check_mark: *8층 주차장 외* 주차 확인 될 경우 *주차 위반 스티커 부착* 등 조치 예정\n"
            ...
            f":heavy_check_mark: *주차등록 링크 : [https://docs.google.com/forms/d/e/1FAIpQLSfK121pYkYfmsL9I9MGX5tgA8Y6u1v03ZOP2RX9stmaLGH_Sg/viewform]\n\n"
            f"*자세한 자료는 스레드 참고 바랍니다!*\n\n"
            f":전화기2: *문의사항 : 인사총무팀 총무/시설 담당자*\n\n"
            f"감사합니다.\n"
        )
